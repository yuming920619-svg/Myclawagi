/******************************************************************************
* File Name   : epl_Memory_Array_sub.v
* Created     : 2026/01/08
* Author      : EPL Lab Memory Test and Repair Group
* Version     : 0.2
*
* Description :
*   Memory Array sub-module (explicit structural netlist style).
*   - Intentionally written in a flat, repetitive format to be generated/edited by Python.
*   - Array size is defined by the spec macros in EPLFFRAM02_spec.vh.
*   - Write:
*       * Each cell write enable = pWl_i[row] & pWe_i[col]
*       * Data in            = pDi_i[col]
*   - Read:
*       * Read data is selected by pWl_i (one-hot or all-zero allowed for idle).
*       * If pWl_i is not one-hot (illegal), output data is forced to 0 to avoid ambiguity.
*   - Handshake:
*       * pRead0_i : read request from upstream
*       * pRead1_o : read valid to downstream (registered)
*
* Notes :
*   - This module prioritizes structural clarity and generator-friendliness over compact RTL.
*
* Modification History :
*   Date        Version    Author                               Description
*   ----------  ---------  -----------------------------------  ----------------
*   2026/01/08  0.1        EPL Lab Memory Test and Repair Group  Skeleton created
*   2026/01/12  0.2        EPL Lab Memory Test and Repair Group  Add generator-friendly header/comments
******************************************************************************/
